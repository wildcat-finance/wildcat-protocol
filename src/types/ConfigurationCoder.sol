...
Configuration constant DefaultConfiguration = Configuration.wrap(0);
...
//////////////////////////////////////////////////////////////*/
	...
	{
		assembly {
			owner := shr(Configuration_owner_bitsAfter, encoded)
			maxTotalSupply := and(MaxUint96, encoded)
		}
	}

	function encode(address owner, uint256 maxTotalSupply)
		internal
		pure
		returns (Configuration encoded)
	{
		assembly {
			...
			encoded := or(shl(Configuration_owner_bitsAfter, owner), maxTotalSupply)
		}
	}
...
//////////////////////////////////////////////////////////////*/
	...
	function setOwner(Configuration old, address owner)
		internal
		pure
...
//////////////////////////////////////////////////////////////*/
	...
	function getMaxTotalSupply(Configuration encoded)
		internal
		pure
	...
	function setMaxTotalSupply(Configuration old, uint256 maxTotalSupply)
		internal
		pure
		returns (Configuration updated)
	{
		assembly {
			...
			updated := or(
				and(old, Configuration_maxTotalSupply_maskOut),
				maxTotalSupply
			)
		}
	}
...
//////////////////////////////////////////////////////////////*/
	...
	function equals(Configuration a, Configuration b)
		internal
		pure
	...
	function isNull(Configuration a) internal pure returns (bool _isNull) {
