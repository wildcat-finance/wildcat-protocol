...
//////////////////////////////////////////////////////////////*/
	...
	function encode(
		...
		assembly {
			...
			encoded := or(
				shl(VaultState_annualInterestBips_bitsAfter, annualInterestBips),
				or(
...
//////////////////////////////////////////////////////////////*/
	...
	function setAnnualInterestBips(VaultState old, uint256 annualInterestBips)
		internal
		pure
