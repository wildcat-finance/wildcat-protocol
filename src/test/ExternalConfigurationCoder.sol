...
contract ExternalConfigurationCoder {
  ...
  {
    (owner, maxTotalSupply) = ConfigurationCoder
  ...
  function encode(
    ...
    (_configuration) = ConfigurationCoder.encode(
      owner,
      maxTotalSupply
    );
  }
  ...
  {
    (owner) = ConfigurationCoder.getOwner(
      _configuration
    );
  }

  function setOwner(address owner) external {
    (_configuration) = ConfigurationCoder
      .setOwner(_configuration, owner);
  }
  ...
  {
    (maxTotalSupply) = ConfigurationCoder
      .getMaxTotalSupply(_configuration);
  }
